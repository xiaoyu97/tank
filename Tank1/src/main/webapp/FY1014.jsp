...
<%--   表单提交  --%>
        <form action="userServlet" method="post">
            ...
            <div id="pwd_i"></div>
            <label class="itemTitle">项目链接</label><input class="project1" type="text" name="link"
                                                        placeholder="请填写项目链接 （选填）"><br>
            <label class="itemTitle">项目周期</label>
            <input class="time" type="date" name="begin" placeholder="开始时间" required="required">
            <input class="time" type="date" name="end" placeholder="结束时间" required="required"><br>
